...
class Pagination {
    constructor(index, pagesize, text) {
        this.index = index;
...
class Partner {
    constructor(partner_id, partner_name, partner_email, password, contact_number, branch, status, company, created_date, updated_date, relation, profile_pic) {
...
class QuantitaiveInfo {
    constructor(partner_id, team_status, admin_status, from_date, to_date, condition) {
        this.partner_id = partner_id;
...
QuantitaiveInfo.ctorParameters = () => [
    null,
    null,
    null,
    null,
...
//# sourceMappingURL=default~main-master-admin-master-admin-module~main-partner-partner-module-es2015.js.map