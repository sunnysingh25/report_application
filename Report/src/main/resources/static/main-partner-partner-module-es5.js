...
var Candidateinfo = /** @class */ (function () {
    function Candidateinfo(candidate_id, candidate_name, created_date, updated_date, stage, quantitative) {
    ...
    Candidateinfo.ctorParameters = function () { return [
        null,
        null,
        null,
        null,
...
var Qualitative = /** @class */ (function () {
    function Qualitative(id, partner, title, information, created_date, updated_date) {
        this.id = id;
    ...
    Qualitative.ctorParameters = function () { return [
        null,
        null,
        null,
        null,
...
var Quantitative = /** @class */ (function () {
    function Quantitative(id, company_name, position_name, candidateinfo, mapping_count, comment, created_date, updated_date, partner) {
        this.id = id;
    ...
    Quantitative.ctorParameters = function () { return [
        null,
        null,
        null,
        null,
...
var AddCandidateComponent = /** @class */ (function () {
    function AddCandidateComponent(dialogRef, data, sharedservice) {
    ...
    AddCandidateComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    AddCandidateComponent.prototype.getStageList = function () {
        var _this = this;
        this.sharedservice.getStages().subscribe(function (data) {
            _this.stageList = data;
            _this.stage = _this.stageList.find(function (x) { return x.stage_id == _this.stage_id; });
        }, function (error) { return _this.sharedservice.sucessMessage("Something went wrong"); });
    };
    AddCandidateComponent.prototype.addCandidate = function (form_addCandidate) {
        var candidate = new app_entities_report_candidateinfo__WEBPACK_IMPORTED_MODULE_5__["Candidateinfo"](null, this.form_addCandidate.get('candidate_name').value, null, null, this.stage, null);
...
var AddQualitativeComponent = /** @class */ (function () {
    function AddQualitativeComponent(sharedservice, router) {
        this.sharedservice = sharedservice;
        this.router = router;
    ...
    AddQualitativeComponent.prototype.ngOnInit = function () {
        this.ckeConfig = {
    ...
    AddQualitativeComponent.prototype.addQualitative = function (form_addpartner) {
        var _this = this;
        var qualitative = new app_entities_report_qualitative__WEBPACK_IMPORTED_MODULE_3__["Qualitative"](null, new app_entities_partner_partner__WEBPACK_IMPORTED_MODULE_4__["Partner"](this.sharedservice.getPartnerID(), null, null, null, null, null, null, null, null, null, null, null), this.form_addreport.get('title').value, this.form_addreport.get('editor').value, null, null);
        this.sharedservice.saveQualitative(qualitative).subscribe(function (data) {
            _this.sharedservice.sucessMessage("Report Added");
            _this.router.navigate(["/partner/report/qualitative"]);
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    AddQualitativeComponent.ctorParameters = function () { return [
    ...
    return AddQualitativeComponent;
}());
...
var AddQuantitativeComponent = /** @class */ (function () {
    function AddQuantitativeComponent(dialog, sharedservice, router) {
        this.dialog = dialog;
        this.sharedservice = sharedservice;
        this.router = router;
        this.candidateList = [];
    ...
    AddQuantitativeComponent.prototype.ngOnInit = function () {
    };
    AddQuantitativeComponent.prototype.addCandidate = function (stage_id) {
        var _this = this;
        var dialogRef = this.dialog.open(_add_candidate_add_candidate_component__WEBPACK_IMPORTED_MODULE_3__["AddCandidateComponent"], {
            width: '600px',
            data: { stage_id: stage_id }
        }).afterClosed().subscribe(function (response) {
            if (response != null) {
                _this.candidateList.push(response);
            }
        });
    };
    AddQuantitativeComponent.prototype.getLength = function (stage_id) {
        if (this.candidateList.length > 0)
            return this.candidateList.filter(function (x) { return x.stage.stage_id == stage_id; }).length;
        else
            return 0;
    };
    AddQuantitativeComponent.prototype.getCandidateList = function () {
        var dialogRef = this.dialog.open(_candidate_list_candidate_list_component__WEBPACK_IMPORTED_MODULE_5__["CandidateListComponent"], {
            width: '550px',
            height: '420px',
            data: { candidateList: this.candidateList }
        });
    };
    AddQuantitativeComponent.prototype.addQualitative = function (form_addpartner) {
        var _this = this;
        var quantitative = new app_entities_report_quantitative__WEBPACK_IMPORTED_MODULE_6__["Quantitative"](null, this.form_addreport.get('client_name').value, this.form_addreport.get('position_name').value, this.candidateList, this.form_addreport.get('mapping').value, this.form_addreport.get('comment').value, null, null, new app_entities_partner_partner__WEBPACK_IMPORTED_MODULE_7__["Partner"](this.sharedservice.getPartnerID(), null, null, null, null, null, null, null, null, null, null, null));
        this.sharedservice.saveQuantitative(quantitative).subscribe(function (data) {
            _this.sharedservice.sucessMessage("Report Added");
            _this.router.navigate(["/partner/report/quantitative"]);
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    AddQuantitativeComponent.ctorParameters = function () { return [
    ...
    return AddQuantitativeComponent;
}());
...
var CandidateListComponent = /** @class */ (function () {
    function CandidateListComponent(dialogRef, data, sharedservice) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.sharedservice = sharedservice;
        this.date = new Date();
    ...
    CandidateListComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    CandidateListComponent.prototype.onPaginateChange = function (event) {
...
var DbAddCandidateComponent = /** @class */ (function () {
    function DbAddCandidateComponent(dialogRef, data, sharedservice) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.sharedservice = sharedservice;
        this.stageList = [];
    ...
    DbAddCandidateComponent.prototype.ngOnInit = function () {
        this.stage_id = this.data.stage_id;
        this.getStageList();
    };
    DbAddCandidateComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    DbAddCandidateComponent.prototype.getStageList = function () {
        var _this = this;
        this.sharedservice.getStages().subscribe(function (data) {
            _this.stageList = data;
            _this.stage = _this.stageList.find(function (x) { return x.stage_id == _this.stage_id; });
    ...
    DbAddCandidateComponent.prototype.addCandidate = function (form_addCandidate) {
        var candidate = new app_entities_report_candidateinfo__WEBPACK_IMPORTED_MODULE_5__["Candidateinfo"](null, this.form_addCandidate.get('candidate_name').value, null, null, this.stage, new app_entities_report_quantitative__WEBPACK_IMPORTED_MODULE_6__["Quantitative"](this.id, null, null, null, null, null, null, null, null));
        this.dialogRef.close(candidate);
    };
    DbAddCandidateComponent.ctorParameters = function () { return [
    ...
    return DbAddCandidateComponent;
}());
...
var DbCandidateListComponent = /** @class */ (function () {
    function DbCandidateListComponent(dialogRef, data, sharedservice) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.sharedservice = sharedservice;
        this.index = 1;
    ...
    DbCandidateListComponent.prototype.ngOnInit = function () {
        this.id = this.data.id;
        this.getCandidateList();
    };
    DbCandidateListComponent.prototype.getCandidateList = function () {
        var _this = this;
        var condition = new app_entities_condition_pagination__WEBPACK_IMPORTED_MODULE_4__["Pagination"](this.index, this.pagesize, null);
        this.sharedservice.getCandidateList(condition, this.id).subscribe(function (data) {
            _this.candidateList = data.data;
            _this.length = data.length;
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    DbCandidateListComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    DbCandidateListComponent.prototype.onPaginateChange = function (event) {
        this.index = event.pageIndex + 1;
        this.pagesize = event.pageSize;
        this.getCandidateList();
    };
    DbCandidateListComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"] }
    ]; };
    ...
    return DbCandidateListComponent;
}());
...
var PartnerDashboardComponent = /** @class */ (function () {
    function PartnerDashboardComponent(sharedservice) {
        this.sharedservice = sharedservice;
    ...
    PartnerDashboardComponent.prototype.ngOnInit = function () {
        this.partner_id = this.sharedservice.getPartnerID();
        this.getPartnerList();
        this.getChartInfo();
    };
    PartnerDashboardComponent.prototype.getChartInfo = function () {
        var _this = this;
        var condition = new app_entities_report_quantitaive_info__WEBPACK_IMPORTED_MODULE_4__["QuantitaiveInfo"](this.partner_id, this.team_status, this.admin_status, this.from_date, this.to_date, null);
        this.sharedservice.getGraphInfo(condition).subscribe(function (data) {
            _this.chart = data;
            _this.drawChart(_this.chart);
        }, function (error) { return _this.sharedservice.sucessMessage("Something Went Wrong"); });
    };
    PartnerDashboardComponent.prototype.getPartnerList = function () {
        var _this = this;
        this.sharedservice.getRelatedPartnerForDashboard(this.sharedservice.getPartnerID()).subscribe(function (data) {
            _this.partner = data;
        }, function (error) { return _this.sharedservice.sucessMessage("Something Went Wrong"); });
    };
    PartnerDashboardComponent.prototype.setPartnerID = function (partner_id) {
        this.partner_id = partner_id;
        this.getChartInfo();
    };
    PartnerDashboardComponent.prototype.drawChart = function (chart) {
        var dchart = new _assets_canvasjs_min__WEBPACK_IMPORTED_MODULE_5__["Chart"]("chartContainer", {
    ...
    PartnerDashboardComponent.prototype.toggle = function () {
        this.team_status = !this.team_status;
        this.getChartInfo();
    };
    PartnerDashboardComponent.prototype.setDate = function () {
    ...
    PartnerDashboardComponent.ctorParameters = function () { return [
...
var PartnerProfileComponent = /** @class */ (function () {
    function PartnerProfileComponent(sharedservice) {
        this.sharedservice = sharedservice;
    ...
    PartnerProfileComponent.prototype.getPartnerInfo = function () {
        var _this = this;
        this.sharedservice.getUserInfo(this.sharedservice.getUserEmail()).subscribe(function (data) {
            _this.partner = data.partner;
            _this.setFormData(_this.partner);
        }, function (error) { return _this.sharedservice.sucessMessage("Something went Wrong"); });
    };
    PartnerProfileComponent.prototype.setFormData = function (partner) {
    ...
    PartnerProfileComponent.prototype.selectFile = function (event) {
    ...
    PartnerProfileComponent.prototype.updateProfile = function (form_updateclientprofile) {
        var _this = this;
        ...
        this.sharedservice.updatePartner(this.partner).subscribe(function (data) {
            if (data) {
                if (_this.profile_status) {
                    _this.saveProfilePic();
                }
                else {
                    _this.sharedservice.sucessMessage("Profile Updated");
                }
            }
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    PartnerProfileComponent.prototype.saveProfilePic = function () {
        var _this = this;
        var fd = new FormData();
        fd.append('pic', this.profile_pic);
        fd.append('file_name', this.partner.profile_pic);
        this.sharedservice.saveProfilePic(fd).subscribe(function (data) {
            if (data) {
    ...
    PartnerProfileComponent.ctorParameters = function () { return [
...
var PartnerReportComponent = /** @class */ (function () {
    function PartnerReportComponent(sharedservice, dialog) {
        this.sharedservice = sharedservice;
        this.dialog = dialog;
    ...
    PartnerReportComponent.prototype.ngOnInit = function () {
        this.getPartnerList();
    };
    PartnerReportComponent.prototype.getPartnerList = function () {
        var _this = this;
        this.sharedservice.getRelatedPartnerForDashboard(this.sharedservice.getPartnerID()).subscribe(function (data) {
            _this.partner = data;
        }, function (error) { return _this.sharedservice.sucessMessage("Something Went Wrong"); });
    };
    PartnerReportComponent.prototype.setPartnerID = function (partner_id) {
        this.partner_id = partner_id;
        this.getTableData();
    };
    PartnerReportComponent.prototype.getTableData = function () {
    ...
    PartnerReportComponent.prototype.setReportType = function (report_type) {
        this.report_type = report_type;
    };
    PartnerReportComponent.prototype.onPaginateChange = function (event) {
        this.index = event.pageIndex + 1;
        this.pagesize = event.pageSize;
        this.getTableData();
    };
    PartnerReportComponent.prototype.getQualitativeData = function () {
        var _this = this;
        var qunatitativeInfo = new app_entities_report_quantitaive_info__WEBPACK_IMPORTED_MODULE_5__["QuantitaiveInfo"](this.partner_id, false, false, this.from_date, this.to_date, new app_entities_condition_pagination__WEBPACK_IMPORTED_MODULE_6__["Pagination"](this.index, this.pagesize, null));
        this.sharedservice.getQualitativeReport(qunatitativeInfo).subscribe(function (data) {
            _this.qualitative = data.data;
            _this.length = data.length;
        }, function (error) { return _this.sharedservice.sucessMessage("Something Went Wrong"); });
    };
    PartnerReportComponent.prototype.getQuantitativeData = function () {
        var _this = this;
        var qunatitativeInfo = new app_entities_report_quantitaive_info__WEBPACK_IMPORTED_MODULE_5__["QuantitaiveInfo"](this.partner_id, false, false, this.from_date, this.to_date, new app_entities_condition_pagination__WEBPACK_IMPORTED_MODULE_6__["Pagination"](this.index, this.pagesize, null));
        this.sharedservice.getQuantitativeReport(qunatitativeInfo).subscribe(function (data) {
            _this.quantitative = data.data;
            _this.length = data.length;
        }, function (error) { return _this.sharedservice.sucessMessage("Something Went Wrong"); });
    };
    PartnerReportComponent.prototype.setDate = function () {
        if (this.f_date.value != null && this.t_date.value != null) {
            this.from_date = this.f_date.value;
            this.to_date = this.t_date.value;
            this.getTableData();
    ...
    PartnerReportComponent.prototype.view = function (id) {
        var report_status = false;
        report_status = this.report_type == 0 ? true : false;
        var dialogRef = this.dialog.open(_view_report_view_report_component__WEBPACK_IMPORTED_MODULE_7__["ViewReportComponent"], {
            width: '700px',
            height: '220px',
            data: { id: id, status: report_status }
        });
    };
    PartnerReportComponent.ctorParameters = function () { return [
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_2__["SharedService"] },
...
var QualtitativeComponent = /** @class */ (function () {
    function QualtitativeComponent(sharedservice, supportservice, router) {
        this.sharedservice = sharedservice;
    ...
    QualtitativeComponent.prototype.ngOnInit = function () {
        this.getQualitativeList();
    };
    QualtitativeComponent.prototype.getQualitativeList = function () {
        var _this = this;
        var condition = new app_entities_condition_pagination__WEBPACK_IMPORTED_MODULE_5__["Pagination"](this.index, this.pagesize, null);
        this.sharedservice.getQualitativeList(condition, this.sharedservice.getPartnerID()).subscribe(function (data) {
            _this.qualitative = data.data;
            _this.length = data.length;
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    QualtitativeComponent.prototype.onPaginateChange = function (event) {
        this.index = event.pageIndex + 1;
        this.pagesize = event.pageSize;
        this.getQualitativeList();
    };
    QualtitativeComponent.prototype.edit = function (id) {
        this.supportservice.changeData(id);
        this.router.navigate(["/partner/report/update-qualitative"]);
    };
    QualtitativeComponent.ctorParameters = function () { return [
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_2__["SharedService"] },
...
var QuantitativeComponent = /** @class */ (function () {
    function QuantitativeComponent(sharedservice, supportservice, router) {
        this.sharedservice = sharedservice;
        this.supportservice = supportservice;
        this.router = router;
        this.index = 1;
    ...
    QuantitativeComponent.prototype.ngOnInit = function () {
        this.getQuantitative();
    };
    QuantitativeComponent.prototype.getQuantitative = function () {
        var _this = this;
        var condition = new app_entities_condition_pagination__WEBPACK_IMPORTED_MODULE_5__["Pagination"](this.index, this.pagesize, null);
        this.sharedservice.getQuantitativeList(condition, this.sharedservice.getPartnerID()).subscribe(function (data) {
            _this.quantitative = data.data;
            _this.length = data.length;
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    QuantitativeComponent.prototype.onPaginateChange = function (event) {
        this.index = event.pageIndex + 1;
        this.pagesize = event.pageSize;
        this.getQuantitative();
    };
    QuantitativeComponent.prototype.edit = function (id) {
        this.supportservice.changeData(id);
        this.router.navigate(["/partner/report/update-quantitative"]);
    };
    QuantitativeComponent.ctorParameters = function () { return [
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_2__["SharedService"] },
        { type: app_service_shared_service_support_service__WEBPACK_IMPORTED_MODULE_3__["SupportService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var UpdateQualitativeComponent = /** @class */ (function () {
    function UpdateQualitativeComponent(sharedservice, supportservice, router) {
        this.sharedservice = sharedservice;
        this.supportservice = supportservice;
        this.router = router;
        this.form_addreport = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    UpdateQualitativeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ckeConfig = {
            allowedContent: false,
            forcePasteAsPlainText: true,
        ...
        this.supportservice.currentdata.subscribe(function (data) { return _this.id = data; });
        this.checkData(this.id);
    };
    UpdateQualitativeComponent.prototype.checkData = function (id) {
        if (id > 0) {
    ...
    UpdateQualitativeComponent.prototype.getQualitativeData = function (id) {
        var _this = this;
        this.sharedservice.getQualitativeByID(id).subscribe(function (data) {
            _this.qualitative = data;
            _this.form_addreport.setValue({
                title: data.title,
                editor: data.information
            });
        });
    };
    UpdateQualitativeComponent.prototype.addQualitative = function (form_addpartner) {
        var _this = this;
        ...
        this.sharedservice.updateQualitative(this.qualitative).subscribe(function (data) {
            _this.sharedservice.sucessMessage("Report Updated");
            _this.router.navigate(["/partner/report/qualitative"]);
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    UpdateQualitativeComponent.ctorParameters = function () { return [
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"] },
    ...
    return UpdateQualitativeComponent;
}());
...
var UpdateQuantitativeComponent = /** @class */ (function () {
    function UpdateQuantitativeComponent(dialog, sharedservice, supportservice, router) {
        this.dialog = dialog;
        this.sharedservice = sharedservice;
        this.supportservice = supportservice;
        this.router = router;
    ...
    UpdateQuantitativeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.supportservice.currentdata.subscribe(function (data) { return _this.id = data; });
        this.checkdata(this.id);
    };
    UpdateQuantitativeComponent.prototype.getStageDistribution = function (id) {
        var _this = this;
        this.sharedservice.getStageDistribution(this.id).subscribe(function (data) {
            _this.distribution = data;
        }, function (error) { return _this.sharedservice.sucessMessage("Something went wrong"); });
    };
    UpdateQuantitativeComponent.prototype.checkdata = function (id) {
        if (id != 0) {
            this.getInfo(id);
        }
        else {
    ...
    UpdateQuantitativeComponent.prototype.getInfo = function (id) {
        var _this = this;
        this.sharedservice.getQuantitativeByID(id).subscribe(function (data) {
            _this.quantitative = data;
            _this.form_addreport.setValue({
                client_name: _this.quantitative.company_name,
                position_name: _this.quantitative.position_name,
                mapping: _this.quantitative.mapping_count,
                comment: _this.quantitative.comment
            });
            _this.getStageDistribution(id);
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    UpdateQuantitativeComponent.prototype.addCandidate = function (stage_id) {
        var _this = this;
        var dialogRef = this.dialog.open(_db_add_candidate_db_add_candidate_component__WEBPACK_IMPORTED_MODULE_7__["DbAddCandidateComponent"], {
            width: '600px',
            data: { stage_id: stage_id, id: this.id }
        }).afterClosed().subscribe(function (response) {
            if (response != null) {
                _this.addDistriButionData(stage_id);
                _this.quantitative.candidateinfo.push(response);
            }
        });
    };
    UpdateQuantitativeComponent.prototype.addDistriButionData = function (stage_id) {
        if (stage_id == 1) {
    ...
    UpdateQuantitativeComponent.prototype.getCandidateList = function () {
        var dialogRef = this.dialog.open(_db_candidate_list_db_candidate_list_component__WEBPACK_IMPORTED_MODULE_8__["DbCandidateListComponent"], {
            width: '550px',
            height: '420px',
            data: { id: this.id }
        });
    };
    UpdateQuantitativeComponent.prototype.addQualitative = function (form_addpartner) {
        var _this = this;
        ...
        this.sharedservice.updateQuantitative(this.quantitative).subscribe(function (data) {
            _this.sharedservice.sucessMessage("Report Added");
            _this.router.navigate(["/partner/report/quantitative"]);
        }, function (error) { return _this.sharedservice.sucessMessage(error.error.message); });
    };
    UpdateQuantitativeComponent.ctorParameters = function () { return [
    ...
    return UpdateQuantitativeComponent;
}());
...
var ViewReportComponent = /** @class */ (function () {
    function ViewReportComponent(dialogRef, dialog, data, sharedservice) {
        this.dialogRef = dialogRef;
        this.dialog = dialog;
        this.data = data;
        this.sharedservice = sharedservice;
    ...
    ViewReportComponent.prototype.getQualitatieData = function (id) {
        var _this = this;
        this.sharedservice.getQualitativeByID(id).subscribe(function (data) {
            _this.qualitative = data;
        }, function (error) { return _this.sharedservice.sucessMessage("Something went wrong"); });
    };
    ViewReportComponent.prototype.getQuantitativeData = function (id) {
        var _this = this;
        this.sharedservice.getQuantitativeByID(id).subscribe(function (data) {
            _this.quantitative = data;
            _this.getStageDistribution(id);
    ...
    ViewReportComponent.prototype.getStageDistribution = function (id) {
        var _this = this;
        this.sharedservice.getStageDistribution(this.id).subscribe(function (data) {
            _this.distribution = data;
        }, function (error) { return _this.sharedservice.sucessMessage("Something went wrong"); });
    };
    ViewReportComponent.prototype.getCandidates = function () {
        var dialogRef = this.dialog.open(_db_candidate_list_db_candidate_list_component__WEBPACK_IMPORTED_MODULE_4__["DbCandidateListComponent"], {
            width: '550px',
            height: '420px',
            data: { id: this.id }
        });
    };
    ViewReportComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    ViewReportComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
        { type: app_service_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"] }
...
var PartnerGuardService = /** @class */ (function () {
    function PartnerGuardService(router) {
        this.router = router;
    }
    PartnerGuardService.prototype.canActivate = function (route, state) {
    ...
    PartnerGuardService.ctorParameters = function () { return [
...
//# sourceMappingURL=main-partner-partner-module-es5.js.map